...
* 02/28/2025 - P. Davis overloaded moveNodeToHead function to accept dll node pointer to more efficeintly move using cachemanager.
*/
...
public:
    ...
    * @return: nothing; updates doubly linked list
    */
    void moveNodeToHead(DllNode* move);
